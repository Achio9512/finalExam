package cr.ac.ucenfotec.cruds.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, cr.ac.ucenfotec.cruds.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, cr.ac.ucenfotec.cruds.repository.UserRepository.USERS_BY_EMAIL_CACHE);
