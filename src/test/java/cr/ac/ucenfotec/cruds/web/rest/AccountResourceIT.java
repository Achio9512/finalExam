...
import cr.ac.ucenfotec.cruds.CrudsExamenApp;
import cr.ac.ucenfotec.cruds.config.Constants;
import cr.ac.ucenfotec.cruds.domain.User;
import cr.ac.ucenfotec.cruds.repository.AuthorityRepository;
import cr.ac.ucenfotec.cruds.repository.UserRepository;
import cr.ac.ucenfotec.cruds.security.AuthoritiesConstants;
import cr.ac.ucenfotec.cruds.service.UserService;
import cr.ac.ucenfotec.cruds.service.dto.PasswordChangeDTO;
import cr.ac.ucenfotec.cruds.service.dto.UserDTO;
import cr.ac.ucenfotec.cruds.web.rest.vm.KeyAndPasswordVM;
import cr.ac.ucenfotec.cruds.web.rest.vm.ManagedUserVM;
...
import static cr.ac.ucenfotec.cruds.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
@SpringBootTest(classes = CrudsExamenApp.class)
